...
vendorRouter.post("/", authMiddleware, roleMiddleware("admin", "procurement_officer"), validateMiddleware(vendorCreateSchema), vendorController.create);
...
vendorRouter.put("/:id", authMiddleware, roleMiddleware("admin", "procurement_officer"), validateMiddleware(vendorUpdateSchema), vendorController.update);
